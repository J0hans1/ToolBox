...
const TwStyles = {
    TextField: 'disabled:text-gray-400 disabled:placeholder-gray-400 dark:disabled:placeholder-gray-500 dark:placeholder-gray-300 placeholder-gray-600 dark:disabled:text-gray-400 dark:disabled:border-gray-500 disabled:border-gray-300 border-gray-400 dark:border-gray-200 dark:placeholder-gray-200 dark:text-dark-white w-full focus:border-black focus:ring-black dark:focus:border-pu-gul dark:focus:ring-pu-gul focus:ring-1 focus:outline-none rounded-md h-14 pl-4 px-3 py-2 shadow-sm bg-transparent border-2 text-lg '
}

export const FooterData = {
    title: 'ToolBox',
    adresse: 'ToolBox AS, Postboks 1234, 1234 Oslo',
    email: 'kontakt@toolbox.no',
    telefon: '+47 123 45 678',
    trademark: '© 2021 ToolBox AS. Alle rettigheter reservert.',
}
...
export const landingData = {
    ...
    userStep : [
        ...
        'Bruk verkøyet til å fullføre ditt prosjekt, og lever tilbake når ferdig.'
    ]
}
...
export const faq = {
    ...
    C3:{
        ...
        qna: [
            {
                Q: "Hvordan kan jeg opprette en annonse?",
    ...
    C4:{
        ...
        qna: [
            {
                Q: "Kan jeg redigere profilinformasjon?",
                A: "Ja, det kan du. Dette gjør du ved å gå inn på 'Min profil' og trykke på 'Endre brukerinfo' under opplysningene dine.  "
            },
        ]
    },
    C5:{
        ...
        qna: [
            {
                Q: "De fleste utleiere svarer veldig raskt",
    ...
    C6:{
        ...
        qna: [
            {
                Q: "Hvordan ta kontakt med kundeservice?",
